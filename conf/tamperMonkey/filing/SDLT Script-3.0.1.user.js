...
var userProfiles = '[' +
    ...
    '{ "description":"98 vendors", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "98-vendors" }, ' +
    '{ "description":"99 vendors", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "99-vendors" }, ' +
    ...
    '{ "description":"Error case: Bad request updating purchaser return agent", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "error-updating-purchaser-return-agent" }, ' +
    '{ "description":"Error case: Bad request creating purchaser return agent", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "error-creating-purchaser-return-agent" }, ' +
    ...
    '{ "description":"Full Purchaser with purchaser return agent", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "full-purchaser-with-agent" },' +
    '{ "description":"Full Purchaser with vendor return agent", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "full-purchaser-with-vendor-agent" },' +
    '{ "description":"One Purchaser of type Company", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "one-purchaser-company" },' +
    '{ "description":"One Purchaser of type Individual", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "one-purchaser-individual" },' +
    '{ "description":"2 Purchasers, Main Purchaser is type Company", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "2-purchasers-company" },' +
    '{ "description":"2 Purchasers, Main Purchaser is type Individual", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "2-purchasers-individual" },' +
    '{ "description":"5 Purchasers, Main Purchaser is type Company", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "5-purchasers-company" },' +
    '{ "description":"5 Purchasers, Main Purchaser is type Individual", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "5-purchasers-individual" },' +
    '{ "description":"Error case: Bad request updating return info", "enrolmentKey":"IR-SDLT-ORG", "identifierName":"STORN", "identifierValue":"", "enrolmentStatus":"Activated", "affinityGroup":"Organisation", "returnId": "error-updating-return-info" },' +
